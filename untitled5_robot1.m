...
while true
    ...
    if torque_input1_sm ~= prev_torque_input1 || ...
       ...
       trajectoryScaling_sm ~= prev_trajectoryScaling ||...
       reactionForce_sm ~= prev_reaction_force
        % If any value has changed, update the database
        
        % Construct the query
        query = sprintf("INSERT INTO matlab_db.urdf_robot_1 (torque_input1, torque_input2, torque_input3, torque_input4, torque_input5, torque_input6, torque_input7, endeffectorPos, endeffectorVel, objectPos,trajectoryScaling, reaction_force, timestamp) VALUES (%f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, '%s')", ...
            torque_input1_sm, torque_input2_sm, torque_input3_sm, torque_input4_sm, torque_input5_sm, torque_input6_sm, torque_input7_sm, endeffectorPos_sm, endeffectorVel_sm, objectPos_sm, trajectoryScaling_sm,reaction_force_sm, customTimestamp);
        ...
        prev_trajectoryScaling = trajectoryScaling_sm;
